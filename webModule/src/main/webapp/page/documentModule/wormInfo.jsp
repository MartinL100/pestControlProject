...
<head>
    ...
    <link rel="stylesheet" href="wormInfo.jsp" media="all">
    <link rel="stylesheet" href="wormInfo.jsp" media="all">
    <link rel="stylesheet" href="wormInfo.jsp" media="all">
...
<div class="layui-card-body" style=" position:relative;left:150px">
    ...
    <img src="#" style=" position:relative;left:474px;top: -20px;width: 120px;height: 160px">

    <span style=" position:relative;left:200px;top: 200px">成虫图片</span>
    <img src="#" style=" position:relative;left:280px;top: 200px ;width: 120px;height: 160px ">
...
<a href="/pestisIndex"><button class="layui-btn layui-btn-primary layui-btn-sm" style=" position:relative;top:250px;left:450px" >返回</button></a>
</body>
</html>
